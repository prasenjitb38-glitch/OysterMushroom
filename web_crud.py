...
def definition(resource):
    ...
    base={
      ...
      "batch":[("batch_no","Batch No","text",None),("production_date","Start Date","date",None),("straw_qty","Straw Kg","number",None),("spawn_qty","Spawn Kg","number",None),("bag_count","Bags","number",None),("expected_yield","Expected Yield Kg","number",None),("expected_harvest_date","Expected Harvest","date",None),("status","Status","select",[(x,x) for x in ("Preparing","Growing","Harvesting","Completed","Failed")]),("notes","Notes","text",None)],
      "production":[("production_date","Date","date",None)]+choices["production"]+[("bags","Bags","number",None),("production_kg","Production Kg","number",None),("wastage_kg","Wastage Kg","number",None),("notes","Notes","text",None)],
