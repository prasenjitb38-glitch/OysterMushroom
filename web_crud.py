...
def definition(resource):
    ...
    base={
      ...
      "material":[("item","Material","text",None),("unit","Unit","select",[(x,x) for x in ("Kg","Gram","Bag","Pcs","Piece","Litre")]),("opening_stock","Opening Stock","number",None),("reorder_level","Reorder Level","number",None)],
